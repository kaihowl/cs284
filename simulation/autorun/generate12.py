...
def gen_config(sleep):
  ...
  APP-CONFIG-FILE template_10nodes.app
  ...
  SUBNET N8-190.0.3.0 {{1 thru 11}} 563.548 98.0411 0
  ...
  [7] IP-ADDRESS[0]             190.0.3.7
  [8] IP-ADDRESS[0]             190.0.3.8
  [9] IP-ADDRESS[0]             190.0.3.9
  [10] IP-ADDRESS[0]            190.0.3.10
  [11] IP-ADDRESS[0]            190.0.3.11
  ...
  [1 thru 11]     ROUTING-PROTOCOL NONE
  [1 thru 11]     BATTERY-MODEL-STATISTICS YES
  [1 thru 11]     NODE-PLACEMENT FILE
  [1 thru 11]     STATIC-ROUTE-FILE /Users/kai/Documents/Studium/UCSB/CS284/repo/cs284/simulation/autorun/template_10nodes/template_10nodes.routes-static
  NODE-POSITION-FILE template_10nodes.nodes
  GUI-ANNOTATION-CONFIG-FILE template_10nodes.ann

  #*********Miscellaneous Configuration***********************************

  GUI-DISPLAY-SETTINGS-FILE template_10nodes.display
...
def gen_app(workload):
  ...
  SUPER-APPLICATION 1 7 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL EXP {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  SUPER-APPLICATION 1 8 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL EXP {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  SUPER-APPLICATION 1 9 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL EXP {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  SUPER-APPLICATION 1 10 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL EXP {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  SUPER-APPLICATION 1 11 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL EXP {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  
  """.format(num_packets, freq)
  
def gen(workload, sleep, number):
  shutil.copytree("../template_10nodes", str(number))
  
  with open("%i/template_10nodes.config"%number, "w") as f:
    f.write(gen_config(sleep))
  
  with open("%i/template_10nodes.app"%number, "w") as f:
