...
def gen_app(workload):
  ...
  return """
  SUPER-APPLICATION 1 2 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL DET {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  SUPER-APPLICATION 1 3 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL DET {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
  SUPER-APPLICATION 1 4 DELIVERY-TYPE UNRELIABLE START-TIME DET 1 DURATION DET 0S REQUEST-NUM DET {0} REQUEST-SIZE DET 8 REQUEST-INTERVAL DET {1}MS REPLY-PROCESS YES REPLY-NUM DET 1 REPLY-SIZE DET 8 REPLY-PROCESS-DELAY DET 100MS REPLY-INTERDEPARTURE-DELAY DET 1S APPLICATION-NAME Measurements 
...
if __name__ == "__main__":
  os.chdir("batch")
  i = 0
  for sleep in (20, 100, 500, 1000):
    print "Starting with sleep %i" % sleep
    for workload in xrange(50, 600, 50):
